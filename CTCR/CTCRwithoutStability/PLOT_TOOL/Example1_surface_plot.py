...
ax.contour3D(XX, ALF0PLT,BET1PLT , zdir='x', levels=[0.5],offset=0.5, colors=['black'],linewidths=[4])
ax.contour3D(XX, ALF0PLT,BET1PLT , zdir='x', levels=[0.7],offset=0.7, colors=['black'],linewidths=[4])
ax.contour3D(XX, ALF0PLT,BET1PLT , zdir='x', levels=[0.9],offset=0.9, colors=['black'],linewidths=[4])
ax.contour3D(XX, ALF0PLT,BET1PLT , zdir='y', levels=[3.14159],offset=3.14159, colors=['red'],linewidths=[4])
...
plt.title('Bifurcation surface when the relative angle between tubes \n in two-tube CTCR is varied for differnt values of section lengths $L_{2}$')
plt.show()
