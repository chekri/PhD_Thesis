...
nonlcon=[];
Objective(Yo,Rtar,R_init,Ori,UFL,USt,F,Tr_current,TRF2,p1,p2,p3,p4)
fun3=@(U)Objective(U,Rtar,R_init,Ori,UFL,USt,F,Tr_current,TRF2,p1,p2,p3,p4)
tic
...
a=y10;
Objective(x,Rtar,R_init,Ori,UFL,USt,F,Tr_current,TRF2,p1,p2,p3,p4)
...
[reach,jac_reach]=Reach_targetandorientation(Rpath,Ori,U_current,Tr_current,Load);
