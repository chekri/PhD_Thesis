...
set(gca,'YTickLabel',[]);
set(gca,'ZTickLabel',[]);
scatter3(sol1.y(16+2,end),sol1.y(16+3,end),sol1.y(16+1,end),'bo');
...
%scatter3(R_tar(2),R_tar(3),R_tar(1),'ko')
%text(R_tar(2),R_tar(3),R_tar(1),'\leftarrow Target','FontSize',12)
%scatter3(R_init(2),R_init(3),R_init(1),'ko')
%text(R_init(2),R_init(3),R_init(1),'\leftarrow Initial point')
%scatter3(Robs(1),Robs(2),Robs(3),'r*')
hold on
...
for k=[0:N]
    ...
    theta=[theta,acosd(dot([d31,d32,d33],Target)/(norm([d31,d32,d33])*norm(Target)))];
   ...
   % plot3(sol.y(2,:),sol.y(3,:),sol.y(1,:),'r:');
    ...
    %plot3(sol.y(32,:),sol.y(33,:),sol.y(31,:),'k:')
     if k==0
        ...
        %plot3([sol.y(18,end),sol.y(18,end)+0.1*d32], [sol.y(19,end),sol.y(19,end)+0.1*d33],[sol.y(17,end),sol.y(17,end)+ 0.1*d31],'m-','LineWidth',3)
        quiver3(sol.y(18,end),sol.y(19,end),sol.y(17,end),d32,d33,d31,0.1,'m-','LineWidth',2)
     end
     ...
     if rem(k,2)==0
        ...
        quiver3(sol.y(18,end),sol.y(19,end),sol.y(17,end),d32,d33,d31,0.1,'m:','LineWidth',1)

        %plot3([sol.y(18,end),sol.y(18,end)+0.1*d32], [sol.y(19,end),sol.y(19,end)+0.1*d33],[sol.y(17,end),sol.y(17,end)+ 0.1*d31],'c-','LineWidth',3)
     end
...
%plot3([sol.y(18,end),sol.y(18,end)+0.1*d32], [sol.y(19,end),sol.y(19,end)+0.1*d33],[sol.y(17,end),sol.y(17,end)+ 0.1*d31],'g-','LineWidth',3)
%plot3([sol.y(18,end),sol.y(18,end)+0.1*Target(2)], [sol.y(19,end),sol.y(19,end)+0.1*Target(3)],[sol.y(17,end),sol.y(17,end)+ 0.1*Target(1)],'k-','LineWidth',3)

%plot3([sol.y(18,end),sol.y(18,end)+0.1*d32], [sol.y(19,end),sol.y(19,end)+0.1*d33],[sol.y(17,end),sol.y(17,end)+ 0.1*d31],'g-','LineWidth',3)
quiver3(sol.y(18,end),sol.y(19,end),sol.y(17,end),d32,d33,d31,0.1,'m-','LineWidth',2)
quiver3(sol.y(18,end),sol.y(19,end),sol.y(17,end),Target(2),Target(3),Target(1),0.1,'k-','LineWidth',2)

%plot3(tipx,tipy,tipz,'g-','Linewidth',1)
xlim([-0.2,0.4])
ylim([0,1.6])
zlim([-0.40,0.25])
plot3(tipx,tipy,tipz,'k-','Linewidth',1)
%legend
...
a5=y5(12*(0:N)+5);
a6=y5(12*(0:N)+6);
plot(linspace(0,1,N+1),a1,'g-','Linewidth',2);
hold on;
grid on;
plot(linspace(0,1,N+1),a2,'b-','Linewidth',2);
plot(linspace(0,1,N+1),a3,'r-','Linewidth',2);
...
ylabel('Controls y(t)','FontSize',18)

fig3=figure(3)

plot(linspace(0,1,N+1),a4,'k-','Linewidth',2);
hold on;
grid on;
plot(linspace(0,1,N+1),a5,'m-','Linewidth',2);
plot(linspace(0,1,N+1),a6,'c-','Linewidth',2);
xlabel('Time t','FontSize',15)
...
ylabel('Angle between the target vector and the tip"s tangent \Theta (in degrees)','FontSize',18)
grid on
