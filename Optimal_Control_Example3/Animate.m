...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Shows the animation of CTCR for the resultant optimal solutions and gives
%the evolution plots of control paramters as well as other funtions
y5=Input{1};   %Array of control paramters and control rate vectors
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Plots the orientation betweet the angle between the Tip tangent 
%% and the Target vector
fig4=figure(4);
plot(linspace(0,1,N+1),theta,'y','LineWidth',2);
hold on
xlabel('Time t','FontSize',15)
