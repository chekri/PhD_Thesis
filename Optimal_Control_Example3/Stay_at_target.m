function [Rt,Jac]=Stay_at_target(Rtar,U,Tr)

B0=[0,0];
Rt=norm([Tr.y(17,end),Tr.y(18,end),Tr.y(19,end)]-Rtar);
...
for i=[1:6]
   ...
   % axis equal 
    tar_diff=norm([p1(end,1),p1(end,2),p1(end,3)] - Rtar);
    Jac(i)=(tar_diff-Rt)/e;
...
tar_diff=norm([y11(end,1),y11(end,2),y11(end,3)] - Rtar) ;
...
tar_diff=norm([y21(end,1),y21(end,2),y21(end,3)] - Rtar);
