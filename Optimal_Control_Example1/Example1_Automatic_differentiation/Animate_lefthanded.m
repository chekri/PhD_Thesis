...
%Gives the animation of the optimal solutions
% Specify the intened Target point
R_tar=[0.4,-0.0,1.0];
%Specify the intended 'FTL' curve
UFL=[0.5,0.5+3.1415,0.5+3.1415,0.4,0.6,0.5];
UFL2=[0.5,0.5+3.1415,0.5+3.1415,0.8+0.4,0.6,0.5];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[RF3,RF2,RF1,t3,t2,t1]=IVP_trajectory([0,0,0,0,0,sin(UFL2(1)/2),cos(UFL2(1)/2),0,0,0,0,0,0,0,UFL2(2)-UFL2(1),0,UFL2(3)-UFL2(1),0],UFL2);
RF3=RF3(:,1:3);
RF2=RF2(:,1:3);
RF1=RF1(:,1:3);
...
for k=[0:N]
    ...
    [J,Fc]=Collocation_Equation(sol,[y5(12*k+1),y5(12*k+2),y5(12*k+3),y5(12*k+4),y5(12*k+5),y5(12*k+6)],P);
    qend1=sol.y(20,end);
    qend2=sol.y(21,end);
    qend3=sol.y(22,end);
    qend4=sol.y(23,end);
    ...
    dev=[dev,Deviation_from_FTL([y5(12*k+1),y5(12*k+2),y5(12*k+3),y5(12*k+4),y5(12*k+5),y5(12*k+6)],sol,UFL2,TrF,J,Fc)];
    hold on    
     if k==0
...
legend('\theta_{1}','\theta_{2} ','\theta_{3} ','FontSize',20);
...
legend('L_{1}','L_{2}','L_{3}  ','FontSize',20);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure(5);
plot(linspace(0,1,N+1),dev,'y');
hold on
xlabel('Time t','FontSize',15)
ylabel('Deviation from the FTL','FontSize',15)
grid on
