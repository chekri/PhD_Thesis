function [Optimal_solution]=Optimize_path_alongpat21(y_init)
%%%%%%%%%%%%%%%%%%%%%
...
pp=1.0;
p1=5*pp; % 0.5 is good
p2=0.0*pp;%0,50,100, 200.0,500.0;
p3=0;
p4=2000*pp;
...
if size(y_init,2)==0
    ...
    a7=y5(12*(0:No-1)+7);
    a7=interp1(linspace(0,1,No),a7,linspace(0,1,N+1));
    a8=y5(12*(0:No-1)+8);
    a8=interp1(linspace(0,1,No),a8,linspace(0,1,N+1));
    a9=y5(12*(0:No-1)+9);
    a9=interp1(linspace(0,1,No),a9,linspace(0,1,N+1)); 
    a10=y5(12*(0:No-1)+10);
    a10=interp1(linspace(0,1,No),a10,linspace(0,1,N+1));
    a11=y5(12*(0:No-1)+11);
    a11=interp1(linspace(0,1,No),a11,linspace(0,1,N+1));
    a12=y5(12*(0:No-1)+12);
    a12=interp1(linspace(0,1,No),a12,linspace(0,1,N+1));
...
%options  = optimoptions('fmincon','Display','iter','Algorithm','interior-point','SpecifyObjectiveGradient',true,'MaxFunctionEvaluations',5000,'SpecifyConstraintGradient',true,'StepTolerance',1e-10,'OptimalityTolerance',1e-08,'ConstraintTolerance',1e-08);
...
y=[USt,y]; 
En=0;
Utar=[0.1,0.2,0.3,0.53,0.66,0.4];
%Number of steps
N=floor(size(y,2)/12);
h=1/N;
rp1=1;
...
U_current=[y(12*T+12+1),y(12*T+12+2),y(12*T+12+3),y(12*T+12+4),y(12*T+12+5),y(12*T+12+6)];
[reach,jac_reach]=Reach_target2(Utar,U_current)
En
reach
sum = p1*En  + p4*reach
jac(12*(N-1)+7:12*(N-1)+12,1)= p4*jac_reach';