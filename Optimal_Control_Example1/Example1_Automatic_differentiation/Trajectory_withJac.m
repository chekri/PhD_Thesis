...
opts = bvpset('FJacobian',@(x,y)CTCR_jac(x,y,Th1,Th2,Th3,L1,L2,L3,Load),'RelTol',1e-8,'Stats','off');
...
function FB = bcs(u0,u1,Th1,Th2,Th3,L1,L2,L3,Load) 
     ...
     % r X N
      ...
      FB(24)= ( u1(23)*u1(24) + u1(22)*u1(25) - u1(21)*u1(26) - u1(20)*u1(27))/2.0 +(e2*Ndir3 - e3*Ndir2);
      FB(25)= (-u1(22)*u1(24) + u1(23)*u1(25) + u1(20)*u1(26) - u1(21)*u1(27))/2.0 +(e3*Ndir1 - e1*Ndir3);%
      FB(26)= ( u1(21)*u1(24) - u1(20)*u1(25) + u1(23)*u1(26) - u1(22)*u1(27))/2.0 +(e1*Ndir2 - e2*Ndir1);
   ...
   function [jac] = CTCR_jac(s,u,th1,th2,th3,L1,L2,L3,Load)
      NDIM=48;
      jac=zeros(NDIM);
      uhat11=0.5;%PAR(5)%1.0
      uhat12=0.0;
...
%       Calculate components of the strain
   ...
   %d mu4
    ...
    w201= -u(23)*u(27)/(4.0*k11)- u(22)*u(26)/(4.0*k12)- u(21)*u(25)/(4.0*k13) + 0.0;                  % 3 rd component only with k13 
	w202= -u(23)*u(26)/(4.0*k11)+ u(22)*u(27)/(4.0*k12)+ u(21)*u(24)/(4.0*k13) + (strain1(3)/2.0);
	w203=  u(23)*u(25)/(4.0*k11) + u(22)*u(24)/(4.0*k12) - u(21)*u(27)/(4.0*k13)- (strain1(2)/2.0);
	w204=  u(23)*u(24)/(4.0*k11) - u(22)*u(25)/(4.0*k12)+ u(21)*u(26)/(4.0*k13) + (strain1(1)/2.0);
	%perfect
	w205=  u(23)*u(23)/(4.0*k11) + u(22)*u(22)/(4.0*k12) + u(21)*u(21)/(4.0*k13);
	w206=  u(22)*u(23)/(4.0*k11) - u(23)*u(22)/(4.0*k12) - u(20)*u(21)/(4.0*k13);
	w207= -u(21)*u(23)/(4.0*k11) - u(20)*u(22)/(4.0*k12) + u(23)*u(21)/(4.0*k13);
	w208= -u(20)*u(23)/(4.0*k11) + u(21)*u(22)/(4.0*k12) - u(22)*u(21)/(4.0*k13);


	w211= -u(22)*u(27)/(4.0*k11)+ u(23)*u(26)/(4.0*k12)+ u(20)*u(25)/(4.0*k13) - strain1(3)/2.0;
	w212= -u(22)*u(26)/(4.0*k11)- u(23)*u(27)/(4.0*k12)- u(20)*u(24)/(4.0*k13) + 0.0;
	w213=  u(22)*u(25)/(4.0*k11) - u(23)*u(24)/(4.0*k12) + u(20)*u(27)/(4.0*k13) + strain1(1)/2.0;
	w214=  u(22)*u(24)/(4.0*k11) + u(23)*u(25)/(4.0*k12) - u(20)*u(26)/(4.0*k13) + strain1(2)/2.0;
	
	w215=  u(23)*u(22)/(4.0*k11) - u(22)*u(23)/(4.0*k12) - u(21)*u(20)/(4.0*k13);
	w216=  u(22)*u(22)/(4.0*k11) + u(23)*u(23)/(4.0*k12) + u(20)*u(20)/(4.0*k13);
	w217= -u(21)*u(22)/(4.0*k11) + u(20)*u(23)/(4.0*k12) - u(23)*u(20)/(4.0*k13);
	w218= -u(20)*u(22)/(4.0*k11) - u(21)*u(23)/(4.0*k12) + u(22)*u(20)/(4.0*k13);


	w221= +u(21)*u(27)/(4.0*k11)+ u(20)*u(26)/(4.0*k12) - u(23)*u(25)/(4.0*k13)  + strain1(2)/2.0;
	w222= +u(21)*u(26)/(4.0*k11)- u(20)*u(27)/(4.0*k12) + u(23)*u(24)/(4.0*k13)  - strain1(1)/2.0;
	w223= -u(21)*u(25)/(4.0*k11) - u(20)*u(24)/(4.0*k12)  - u(23)*u(27)/(4.0*k13) + 0.0;
	w224= -u(21)*u(24)/(4.0*k11) + u(20)*u(25)/(4.0*k12)  + u(23)*u(26)/(4.0*k13) + strain1(3)/2.0;
	
	w225= -u(23)*u(21)/(4.0*k11) - u(22)*u(20)/(4.0*k12) + u(21)*u(23)/(4.0*k13);
	w226= -u(22)*u(21)/(4.0*k11) + u(23)*u(20)/(4.0*k12) - u(20)*u(23)/(4.0*k13);
	w227= u(21)*u(21)/(4.0*k11) + u(20)*u(20)/(4.0*k12) + u(23)*u(23)/(4.0*k13);
	w228= u(20)*u(21)/(4.0*k11) - u(21)*u(20)/(4.0*k12) - u(22)*u(23)/(4.0*k13);

	w231= +u(20)*u(27)/(4.0*k11)- u(21)*u(26)/(4.0*k12)+ u(22)*u(25)/(4.0*k13)  - strain1(1)/2.0;
	w232= +u(20)*u(26)/(4.0*k11)+ u(21)*u(27)/(4.0*k12)- u(22)*u(24)/(4.0*k13)  - strain1(2)/2.0;	
	w233= -u(20)*u(25)/(4.0*k11) + u(21)*u(24)/(4.0*k12) + u(22)*u(27)/(4.0*k13) - strain1(3)/2.0;
	w234= -u(20)*u(24)/(4.0*k11) - u(21)*u(25)/(4.0*k12) - u(22)*u(26)/(4.0*k13) + 0.0;
	
	w235= -u(23)*u(20)/(4.0*k11) + u(22)*u(21)/(4.0*k12) - u(21)*u(22)/(4.0*k13);
	w236= -u(22)*u(20)/(4.0*k11) - u(23)*u(21)/(4.0*k12) + u(20)*u(22)/(4.0*k13);
	w237=  u(21)*u(20)/(4.0*k11) - u(20)*u(21)/(4.0*k12) - u(23)*u(22)/(4.0*k13);
	w238=  u(20)*u(20)/(4.0*k11) + u(21)*u(21)/(4.0*k12) + u(22)*u(22)/(4.0*k13);
     
	w241= -u(27)*u(27)/(4.0*k11) - u(26)*u(26)/(4.0*k12)- u(25)*u(25)/(4.0*k13) +2.0*u(30);
	w242= -u(27)*u(26)/(4.0*k11) + u(26)*u(27)/(4.0*k12) + u(25)*u(24)/(4.0*k13);
	w243=  u(27)*u(25)/(4.0*k11)  + u(26)*u(24)/(4.0*k12) - u(25)*u(27)/(4.0*k13) -2.0*u(28);
	w244=  u(27)*u(24)/(4.0*k11) - u(26)*u(25)/(4.0*k12) + u(25)*u(26)/(4.0*k13)  +2.0*u(29);
	
	w245=  u(23)*u(27)/(4.0*k11) + u(22)*u(26)/(4.0*k12) + u(21)*u(25)/(4.0*k13) + 0.0;
	w246=  u(22)*u(27)/(4.0*k11) - u(23)*u(26)/(4.0*k12) - u(20)*u(25)/(4.0*k13) + strain1(3)/2.0;
	w247= -u(21)*u(27)/(4.0*k11) - u(20)*u(26)/(4.0*k12) + u(23)*u(25)/(4.0*k13) - strain1(2)/2.0;
	w248= -u(20)*u(27)/(4.0*k11) + u(21)*u(26)/(4.0*k12) - u(22)*u(25)/(4.0*k13) + strain1(1)/2.0;
	
	w251= -u(26)*u(27)/(4.0*k11) + u(27)*u(26)/(4.0*k12) + u(24)*u(25)/(4.0*k13);
	w252= -u(26)*u(26)/(4.0*k11) - u(27)*u(27)/(4.0*k12) - u(24)*u(24)/(4.0*k13)  + 2.0*u(30); 
	w253=  u(26)*u(25)/(4.0*k11)  - u(27)*u(24)/(4.0*k12)  + u(24)*u(27)/(4.0*k13) - 2.0*u(29);  	
	w254=  u(26)*u(24)/(4.0*k11)  + u(27)*u(25)/(4.0*k12)  - u(24)*u(26)/(4.0*k13) - 2.0*u(28); 

	w255=  u(23)*u(26)/(4.0*k11) - u(22)*u(27)/(4.0*k12) - u(21)*u(24)/(4.0*k13) - strain1(3)/2.0;
	w256=  u(22)*u(26)/(4.0*k11) + u(23)*u(27)/(4.0*k12) + u(20)*u(24)/(4.0*k13) + 0.0;
	w257= -u(21)*u(26)/(4.0*k11) + u(20)*u(27)/(4.0*k12) - u(23)*u(24)/(4.0*k13) + strain1(1)/2.0;
	w258= -u(20)*u(26)/(4.0*k11) - u(21)*u(27)/(4.0*k12) + u(22)*u(24)/(4.0*k13) + strain1(2)/2.0;
	
	w261= +u(25)*u(27)/(4.0*k11) + u(24)*u(26)/(4.0*k12) - u(27)*u(25)/(4.0*k13) - 2.0*u(28); 
	w262= +u(25)*u(26)/(4.0*k11) - u(24)*u(27)/(4.0*k12) + u(27)*u(24)/(4.0*k13) - 2.0*u(29); 
	w263= -u(25)*u(25)/(4.0*k11)  - u(24)*u(24)/(4.0*k12)  - u(27)*u(27)/(4.0*k13)- 2.0*u(30);  
	w264= -u(25)*u(24)/(4.0*k11)  + u(24)*u(25)/(4.0*k12)  + u(27)*u(26)/(4.0*k13);
	
	w265= -u(23)*u(25)/(4.0*k11) - u(22)*u(24)/(4.0*k12) + u(21)*u(27)/(4.0*k13) + strain1(2)/2.0;
	w266= -u(22)*u(25)/(4.0*k11) + u(23)*u(24)/(4.0*k12) - u(20)*u(27)/(4.0*k13) - strain1(1)/2.0;
	w267=  u(21)*u(25)/(4.0*k11) + u(20)*u(24)/(4.0*k12) + u(23)*u(27)/(4.0*k13) + 0.0;
	w268=  u(20)*u(25)/(4.0*k11) - u(21)*u(24)/(4.0*k12) - u(22)*u(27)/(4.0*k13) + strain1(3)/2.0;
	
	w271=  u(24)*u(27)/(4.0*k11) - u(25)*u(26)/(4.0*k12) + u(26)*u(25)/(4.0*k13) + 2.0*u(29); 
	w272=  u(24)*u(26)/(4.0*k11) + u(25)*u(27)/(4.0*k12) - u(26)*u(24)/(4.0*k13) - 2.0*u(28); 
	w273= -u(24)*u(25)/(4.0*k11)  + u(25)*u(24)/(4.0*k12)  + u(26)*u(27)/(4.0*k13);
	w274= -u(24)*u(24)/(4.0*k11)  - u(25)*u(25)/(4.0*k12)  - u(26)*u(26)/(4.0*k13)- 2.0*u(30);  	
	
	w275= -u(23)*u(24)/(4.0*k11) + u(22)*u(25)/(4.0*k12) - u(21)*u(26)/(4.0*k13) - strain1(1)/2.0;
	w276= -u(22)*u(24)/(4.0*k11) - u(23)*u(25)/(4.0*k12) + u(20)*u(26)/(4.0*k13) - strain1(2)/2.0;
	w277=  u(21)*u(24)/(4.0*k11) - u(20)*u(25)/(4.0*k12) - u(23)*u(26)/(4.0*k13) - strain1(3)/2.0;
	w278=  u(20)*u(24)/(4.0*k11) + u(21)*u(25)/(4.0*k12) + u(22)*u(26)/(4.0*k13) - 0.0;
