...
%optimization and this program utilized area swept by CTCR as Covered
%Volume measure. (Chapter 9 of the thesis). But the gradient of Sweep_area with
%respect to the control paramters depends only on rotation paramters 
% and components with respect to length paramters are zero.
...
%Slight perturbation from the Follow-the Leader
USt=UFL + [0,0.1,0.2,0.0,0,0]; % Not needed for this problem
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
options  = optimoptions('fmincon','Display','iter','Algorithm','interior-point','SpecifyObjectiveGradient',true,'Diagnostics','on','MaxFunctionEvaluations',5000,'SpecifyConstraintGradient',true,'StepTolerance',0.2*1e-09,'OptimalityTolerance',1e-06);
nonlcon=[];
...
[sweep,jac_sweep1,jac_sweep2]=Sweep_area_non(Tr_current,Tr_prev,U_current,U_prev,Load);
sweep_area= sweep; 
reach_along=  reach*h; 
...
%[reach,jac_reach]=Reach_target(Rtar,U_current,Tr_current);    %Evaluates gradients Using IVPs
[reach,jac_reach]=Reach_target2(Rtar,U_current,Tr_current,Load);% Evaluates gradients Using BVPs
