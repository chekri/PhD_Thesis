...
%
%p3,p2,p1 are the array of possitin vectors of CTCR corresponding to
%Three-tube section, Two-tube section and one-tube section. 
%t3,t2,t1 are arclength paramters corresponding to corresponding to
%Three-tube section, Two-tube section and one-tube section
%Make sure to change the system parameters such as intriniic curvatures and
%stiffness of the tubes if there are any changes.
Th1=C(1);
Th2=C(2);
Th3=C(3);
L1=C(4);
