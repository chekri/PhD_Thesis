...
a6=y5(12*(0:N-1)+6);
subplot(2,1,1)
plot(linspace(0,1,N),a1,'g-o','LineWidth',2);
hold on;
grid on;
plot(linspace(0,1,N),a2,'b-o','LineWidth',2);
plot(linspace(0,1,N),a3,'r-o','LineWidth',2);
...
hold on;
grid on;
plot(linspace(0,1,N),a4,'k-o','LineWidth',2);
plot(linspace(0,1,N),a5,'m-o','LineWidth',2);
plot(linspace(0,1,N),a6,'c-o','LineWidth',2);
...
a5=y5(12*(0:N-1)+11);
a6=y5(12*(0:N-1)+12);
plot(linspace(0,1,N),a1,'g-^');
hold on;
grid on;
plot(linspace(0,1,N),a2,'b-^');
plot(linspace(0,1,N),a3,'r-^');
plot(linspace(0,1,N),a4,'k-^');
plot(linspace(0,1,N),a5,'m-^');
plot(linspace(0,1,N),a6,'c-^');
xlabel('Time t','FontSize',15)
