...
fig=figure(1)
plot(sol1.y(33,:),sol1.y(31,:),'k','LineWidth',1);
hold on
grid on
plot(sol1.y(3,:),sol1.y(1,:),'r','LineWidth',1);
plot(sol1.y(16+3,:),sol1.y(16+1,:),'b');
axis equal
set(gca,'XTickLabel',[]);
set(gca,'YTickLabel',[]);
set(gca,'ZTickLabel',[]);
scatter(sol1.y(16+3,end),sol1.y(16+1,end),'b*');
%text(sol1.y(16+2,end),sol1.y(16+3,end),sol1.y(16+1,end),'\rightarrow Initial Point','FontSize',12)

scatter(R_tar(3),R_tar(1),'k*')
...
for k=[0:N]
   ...
   % plot3(sol.y(2,:),sol.y(3,:),sol.y(1,:),'r:');
    ...
    %plot3(sol.y(32,:),sol.y(33,:),sol.y(31,:),'k:');
     ...
     if k==0
        plot(sol.y(3,:),sol.y(1,:),'r-','LineWidth',3);
        plot(sol.y(16+3,:),sol.y(16+1,:),'b-','LineWidth',3);
        plot(sol.y(33,:),sol.y(31,:),'k-','LineWidth',3);
        %plot3([sol.y(18,end),sol.y(18,end)+0.1*d32], [sol.y(19,end),sol.y(19,end)+0.1*d33],[sol.y(17,end),sol.y(17,end)+ 0.1*d31],'c-')
     end
     
      if rem(k,5)==0
         k/5
        plot(sol.y(3,:),sol.y(1,:),'r:','LineWidth',1);
        plot(sol.y(16+3,:),sol.y(16+1,:),'b:','LineWidth',1);
        plot(sol.y(33,:),sol.y(31,:),'k:','LineWidth',1);
        %plot3([sol.y(18,end),sol.y(18,end)+0.1*d32], [sol.y(19,end),sol.y(19,end)+0.1*d33],[sol.y(17,end),sol.y(17,end)+ 0.1*d31],'c-')
     end
