...
% optimization. This function utilizes deviation from FTL as a Covered
% Volume measure (Chapter 9 of the thesis). But the gradient from the 
% deviation_from_FTL function with respect to control paramters depends 
% only on rotation paramters and components with respect to length paramters are zero.
% Output: Array of collection of control parameters, control parameter 
% vectors at the mesh points
%%% Target point
Rtar=[0.4,-0.0,1.0];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Output={Optimal_solution,Rtar,Load};
